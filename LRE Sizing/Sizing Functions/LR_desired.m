...
Thrust = ; %[N]
Fuel ; %'RP-1'
Fuel_Temp = ; %[K] 298.150 for RP-1
Oxidixer = ; %'O2(L)'
Ox_Temp = ; %[K] 90.170 for O2(L)
Chamber_Pressure = ; %[Pa]
Chamber_Diameter = ; %[m]
OF1 = ; %OF lower bound
OF2 = ; %OF upper bound
...
%example input:[out] = liquid_rocket_engine_design(5000, 'RP-1', 298.150, 'O2(L)', 90.170,150, 150, 0.1, 5) 
...
% 1)Commented out unit conversions to maintain SI units
