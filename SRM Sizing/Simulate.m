...
function [T, W, P_c, Thrust, R_b, burn_time, Mdot, A_t, deltaV, specificImpulse, propMass] = Simulate(dt, shape, length, width, innerWidth, maxPres, f_inert)
%% Constants (SI)
g = 9.81; 
%% Inputs
%time step [seconds]
